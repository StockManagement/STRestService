...
public class LandmarkFacadeREST extends AbstractFacade<Landmark> {
    ...
    public void create(Landmark entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Landmark entity) {
        super.edit(entity);
    }
    ...
    public Landmark find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Landmark> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
