 ...
 */
package com.smartify.strestservice.service;

import com.smartify.strestservice.Category;
 ...
 */
@Stateless
@Path("com.smartify.strestservice.category")
public class CategoryFacadeREST extends AbstractFacade<Category> {

    @PersistenceContext(unitName = "com.smartify_STRestService_war_1.0-SNAPSHOTPU")
